...
INSANE_SKIP_${PN} += "already-strippedi ldflags"
LICENSE = "Apache-2.0"
...
do_install_append() {
    ...
    ln -sf ${base_libdir}/firmware/ap6212/fw_bcm43438a0.bin ${D}${base_libdir}/firmware/brcm/brcmfmac43430a0-sdio.bin
    ln -sf ${base_libdir}/firmware/ap6212/nvram.txt ${D}${base_libdir}/firmware/brcm/brcmfmac43430a0-sdio.txt
    ln -sf ${base_libdir}/firmware/ap6212/fw_bcm43438a1.bin ${D}${base_libdir}/firmware/brcm/brcmfmac43430-sdio.bin
    ln -sf ${base_libdir}/firmware/ap6212/nvram_ap6212.txt ${D}${base_libdir}/firmware/brcm/brcmfmac43430-sdio.txt
